...
namespace LewisFam.Common.Util
{
    public static partial class JsonUtil
    {
        ...
        public static string SerializeObject(object obj, bool format = false) => obj.ToJson(format);

        public static async Task<string> SerializeObjectAsync(object obj, bool format = false) => await obj.ToJsonAsync(format);
