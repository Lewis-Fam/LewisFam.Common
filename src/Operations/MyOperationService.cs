namespace LewisFam.Common.Operations
{
    internal class MyOperationService
    {
        public MyOperationService(
            IMyOperationTransient transientOperation,
            IMyOperationScoped scopedOperation,
            IMyOperationSingleton singletonOperation,
            IMyOperationSingletonInstance instanceOperation)
        {
